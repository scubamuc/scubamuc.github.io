...
* [Scripted](https://github.com/scubamuc/scubamuc.github.io/dlob/scubamuc/Readme.md#backup-lxc-container-with-snapshotimage--restore-in-shell-scripted-or-gui-lxdmosaic) automatic synchronisation to LXD-backup-server (_weekly_)
